...
public final class ActivityLoginScreenBinding implements ViewBinding {
  ...
  private ActivityLoginScreenBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnFb,
  ...
  public static ActivityLoginScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginScreenBinding((ConstraintLayout) rootView, btnFb, btnGmail, main);
    }
